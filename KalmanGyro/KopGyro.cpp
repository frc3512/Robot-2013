...
const UINT32 KopGyro::kOversampleBits;
const UINT32 KopGyro::kAverageBits;
constexpr float KopGyro::kSamplesPerSecond;
constexpr float KopGyro::kCalibrationSampleTime;
constexpr float KopGyro::kDefaultVoltsPerDegreePerSecond;
 ...
 */
KopGyro::KopGyro(UINT8 moduleNumber, UINT32 channel)
{
 ...
 */
KopGyro::KopGyro(UINT32 channel)
{
 ...
 */
KopGyro::KopGyro(AnalogChannel *channel)
{
	m_analog = channel;
 ...
 */
void KopGyro::SetSensitivity( float voltsPerDegreePerSecond )
{
