...
KOP_ADXL345::KOP_ADXL345(UINT32 gyroSlot, UINT32 gyroChannel, UINT32 i2cSlot,
...
int KOP_ADXL345::readGyroX() {
    if (m_gyro != NULL) {
        return static_cast<int>(
            (m_gyro->GetAverageVoltage(m_gyroChannel) - getGyroXzero()) /
            getGyroLSBsPerUnit());
    } else {
        return 0;
    }
...
double KOP_ADXL345::getGyroXzero() { return 2.5; }

double KOP_ADXL345::getAccelXzero() { return -200; }

double KOP_ADXL345::getAccelYzero() { return 44; }

double KOP_ADXL345::getAccelZzero() { return 660; }
...
double KOP_ADXL345::getGyroLSBsPerUnit() { return 0.007; }
