 ...
 *
 * Call graphData(2) to send data over the network to a LiveGrapher client.
 *
 * The time value in each data pair is handled internally.
 *
 * Use the function hasIntervalPassed(0) to limit the frequency of data sending
...
public:
     ...
     * hasIntervalPassed(0) return false)
     */
    void resetInterval();
